...
class CustomLabel(QLabel):
    ...
    def __init__(self, parent=None, width=0, height=40, name="", color="B"):
        ...
        # Label style sheet
        if color == "B":
            self.setStyleSheet("QLabel { background-color:rgb(85, 94, 110); color : white; border: none; }")
        else:
            ...
            self.setStyleSheet("QLabel { background-color:rgb(150, 170, 200); color : white; border: none; }")
